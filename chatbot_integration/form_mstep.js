$(document).ready(function(){
  ...
  function loadCountriesWithFlags() {
    ...
    // Liste complète des pays avec codes de drapeaux (170+ pays en français)
    var countries = [
      {code: 'ZA', name: 'Afrique du Sud', flag: 'za'},
      {code: 'AF', name: 'Afghanistan', flag: 'af'},
      {code: 'AL', name: 'Albanie', flag: 'al'},
      {code: 'DZ', name: 'Algérie', flag: 'dz'},
      {code: 'DE', name: 'Allemagne', flag: 'de'},
      {code: 'AD', name: 'Andorre', flag: 'ad'},
      {code: 'AO', name: 'Angola', flag: 'ao'},
      {code: 'SA', name: 'Arabie Saoudite', flag: 'sa'},
      {code: 'AR', name: 'Argentine', flag: 'ar'},
      {code: 'AM', name: 'Arménie', flag: 'am'},
      {code: 'AU', name: 'Australie', flag: 'au'},
      {code: 'AT', name: 'Autriche', flag: 'at'},
      {code: 'AZ', name: 'Azerbaïdjan', flag: 'az'},
      {code: 'BS', name: 'Bahamas', flag: 'bs'},
      {code: 'BH', name: 'Bahreïn', flag: 'bh'},
      {code: 'BD', name: 'Bangladesh', flag: 'bd'},
      {code: 'BE', name: 'Belgique', flag: 'be'},
      {code: 'BJ', name: 'Bénin', flag: 'bj'},
      {code: 'BY', name: 'Biélorussie', flag: 'by'},
      {code: 'BO', name: 'Bolivie', flag: 'bo'},
      {code: 'BA', name: 'Bosnie-Herzégovine', flag: 'ba'},
      {code: 'BW', name: 'Botswana', flag: 'bw'},
      {code: 'BR', name: 'Brésil', flag: 'br'},
      {code: 'BF', name: 'Burkina Faso', flag: 'bf'},
      {code: 'BI', name: 'Burundi', flag: 'bi'},
      {code: 'KH', name: 'Cambodge', flag: 'kh'},
      {code: 'CM', name: 'Cameroun', flag: 'cm'},
      {code: 'CA', name: 'Canada', flag: 'ca'},
      {code: 'CL', name: 'Chili', flag: 'cl'},
      {code: 'CN', name: 'Chine', flag: 'cn'},
      {code: 'CY', name: 'Chypre', flag: 'cy'},
      {code: 'CO', name: 'Colombie', flag: 'co'},
      {code: 'KM', name: 'Comores', flag: 'km'},
      {code: 'CG', name: 'Congo', flag: 'cg'},
      {code: 'KP', name: 'Corée du Nord', flag: 'kp'},
      {code: 'KR', name: 'Corée du Sud', flag: 'kr'},
      {code: 'CR', name: 'Costa Rica', flag: 'cr'},
      {code: 'CI', name: 'Côte d\'Ivoire', flag: 'ci'},
      {code: 'HR', name: 'Croatie', flag: 'hr'},
      ...
      {code: 'EC', name: 'Équateur', flag: 'ec'},
      {code: 'ER', name: 'Érythrée', flag: 'er'},
      {code: 'ES', name: 'Espagne', flag: 'es'},
      {code: 'EE', name: 'Estonie', flag: 'ee'},
      {code: 'US', name: 'États-Unis', flag: 'us'},
      {code: 'ET', name: 'Éthiopie', flag: 'et'},
      {code: 'FJ', name: 'Fidji', flag: 'fj'},
      {code: 'FI', name: 'Finlande', flag: 'fi'},
      {code: 'FR', name: 'France', flag: 'fr'},
      {code: 'GA', name: 'Gabon', flag: 'ga'},
      {code: 'GM', name: 'Gambie', flag: 'gm'},
      {code: 'GE', name: 'Géorgie', flag: 'ge'},
      {code: 'GH', name: 'Ghana', flag: 'gh'},
      {code: 'GR', name: 'Grèce', flag: 'gr'},
      {code: 'GT', name: 'Guatemala', flag: 'gt'},
      {code: 'GN', name: 'Guinée', flag: 'gn'},
      {code: 'GQ', name: 'Guinée équatoriale', flag: 'gq'},
      {code: 'GW', name: 'Guinée-Bissau', flag: 'gw'},
      {code: 'HT', name: 'Haïti', flag: 'ht'},
      {code: 'HN', name: 'Honduras', flag: 'hn'},
      {code: 'HU', name: 'Hongrie', flag: 'hu'},
      {code: 'IN', name: 'Inde', flag: 'in'},
      {code: 'ID', name: 'Indonésie', flag: 'id'},
      {code: 'IQ', name: 'Irak', flag: 'iq'},
      {code: 'IR', name: 'Iran', flag: 'ir'},
      {code: 'IE', name: 'Irlande', flag: 'ie'},
      {code: 'IS', name: 'Islande', flag: 'is'},
      {code: 'IL', name: 'Israël', flag: 'il'},
      {code: 'IT', name: 'Italie', flag: 'it'},
      {code: 'JM', name: 'Jamaïque', flag: 'jm'},
      {code: 'JP', name: 'Japon', flag: 'jp'},
      {code: 'JO', name: 'Jordanie', flag: 'jo'},
      {code: 'KZ', name: 'Kazakhstan', flag: 'kz'},
      {code: 'KE', name: 'Kenya', flag: 'ke'},
      {code: 'KG', name: 'Kirghizistan', flag: 'kg'},
      {code: 'KW', name: 'Koweït', flag: 'kw'},
      {code: 'LA', name: 'Laos', flag: 'la'},
      {code: 'LS', name: 'Lesotho', flag: 'ls'},
      {code: 'LV', name: 'Lettonie', flag: 'lv'},
      {code: 'LB', name: 'Liban', flag: 'lb'},
      {code: 'LR', name: 'Liberia', flag: 'lr'},
      {code: 'LI', name: 'Liechtenstein', flag: 'li'},
      {code: 'LY', name: 'Libye', flag: 'ly'},
      {code: 'LT', name: 'Lituanie', flag: 'lt'},
      {code: 'LU', name: 'Luxembourg', flag: 'lu'},
      {code: 'MG', name: 'Madagascar', flag: 'mg'},
      {code: 'MY', name: 'Malaisie', flag: 'my'},
      {code: 'MW', name: 'Malawi', flag: 'mw'},
      {code: 'MV', name: 'Maldives', flag: 'mv'},
      {code: 'ML', name: 'Mali', flag: 'ml'},
      {code: 'MT', name: 'Malte', flag: 'mt'},
      {code: 'MA', name: 'Maroc', flag: 'ma'},
      {code: 'MU', name: 'Maurice', flag: 'mu'},
      {code: 'MR', name: 'Mauritanie', flag: 'mr'},
      {code: 'MX', name: 'Mexique', flag: 'mx'},
      {code: 'MD', name: 'Moldavie', flag: 'md'},
      {code: 'MC', name: 'Monaco', flag: 'mc'},
      {code: 'MN', name: 'Mongolie', flag: 'mn'},
      {code: 'ME', name: 'Monténégro', flag: 'me'},
      {code: 'MZ', name: 'Mozambique', flag: 'mz'},
      {code: 'MM', name: 'Myanmar', flag: 'mm'},
      {code: 'NA', name: 'Namibie', flag: 'na'},
      {code: 'NP', name: 'Népal', flag: 'np'},
      {code: 'NI', name: 'Nicaragua', flag: 'ni'},
      {code: 'NE', name: 'Niger', flag: 'ne'},
      {code: 'NG', name: 'Nigeria', flag: 'ng'},
      {code: 'NO', name: 'Norvège', flag: 'no'},
      {code: 'NZ', name: 'Nouvelle-Zélande', flag: 'nz'},
      {code: 'OM', name: 'Oman', flag: 'om'},
      {code: 'UG', name: 'Ouganda', flag: 'ug'},
      {code: 'UZ', name: 'Ouzbékistan', flag: 'uz'},
      {code: 'PK', name: 'Pakistan', flag: 'pk'},
      {code: 'PA', name: 'Panama', flag: 'pa'},
      {code: 'PG', name: 'Papouasie-Nouvelle-Guinée', flag: 'pg'},
      {code: 'PY', name: 'Paraguay', flag: 'py'},
      {code: 'NL', name: 'Pays-Bas', flag: 'nl'},
      {code: 'PE', name: 'Pérou', flag: 'pe'},
      {code: 'PH', name: 'Philippines', flag: 'ph'},
      {code: 'PL', name: 'Pologne', flag: 'pl'},
      {code: 'PT', name: 'Portugal', flag: 'pt'},
      {code: 'QA', name: 'Qatar', flag: 'qa'},
      {code: 'CD', name: 'République Démocratique du Congo', flag: 'cd'},
      {code: 'CF', name: 'République Centrafricaine', flag: 'cf'},
      {code: 'DO', name: 'République Dominicaine', flag: 'do'},
      {code: 'CZ', name: 'République Tchèque', flag: 'cz'},
      {code: 'RO', name: 'Roumanie', flag: 'ro'},
      {code: 'GB', name: 'Royaume-Uni', flag: 'gb'},
      {code: 'RU', name: 'Russie', flag: 'ru'},
      {code: 'RW', name: 'Rwanda', flag: 'rw'},
      {code: 'SV', name: 'Salvador', flag: 'sv'},
      {code: 'ST', name: 'São Tomé-et-Príncipe', flag: 'st'},
      {code: 'SN', name: 'Sénégal', flag: 'sn'},
      {code: 'RS', name: 'Serbie', flag: 'rs'},
      {code: 'SC', name: 'Seychelles', flag: 'sc'},
      {code: 'SL', name: 'Sierra Leone', flag: 'sl'},
      {code: 'SG', name: 'Singapour', flag: 'sg'},
      {code: 'SK', name: 'Slovaquie', flag: 'sk'},
      {code: 'SI', name: 'Slovénie', flag: 'si'},
      {code: 'SO', name: 'Somalie', flag: 'so'},
      {code: 'SD', name: 'Soudan', flag: 'sd'},
      {code: 'SS', name: 'Soudan du Sud', flag: 'ss'},
      {code: 'LK', name: 'Sri Lanka', flag: 'lk'},
      {code: 'SE', name: 'Suède', flag: 'se'},
      {code: 'CH', name: 'Suisse', flag: 'ch'},
      {code: 'SR', name: 'Suriname', flag: 'sr'},
      {code: 'SY', name: 'Syrie', flag: 'sy'},
      {code: 'TJ', name: 'Tadjikistan', flag: 'tj'},
      {code: 'TW', name: 'Taïwan', flag: 'tw'},
      {code: 'TZ', name: 'Tanzanie', flag: 'tz'},
      {code: 'TD', name: 'Tchad', flag: 'td'},
      {code: 'TH', name: 'Thaïlande', flag: 'th'},
      {code: 'TG', name: 'Togo', flag: 'tg'},
      {code: 'TT', name: 'Trinité-et-Tobago', flag: 'tt'},
      {code: 'TN', name: 'Tunisie', flag: 'tn'},
      {code: 'TM', name: 'Turkménistan', flag: 'tm'},
      {code: 'TR', name: 'Turquie', flag: 'tr'},
      {code: 'UA', name: 'Ukraine', flag: 'ua'},
      {code: 'UY', name: 'Uruguay', flag: 'uy'},
      {code: 'VE', name: 'Venezuela', flag: 've'},
      {code: 'VN', name: 'Vietnam', flag: 'vn'},
      {code: 'YE', name: 'Yémen', flag: 'ye'},
      {code: 'ZM', name: 'Zambie', flag: 'zm'},
  ...
  function loadPhonePrefixes() {
    ...
    // Liste des pays avec codes de drapeaux et préfixes téléphoniques (noms complets)
    var countriesWithPrefixes = [
        {code: 'ZA', name: 'Afrique du Sud', prefix: '+27', flag: 'za'},
        {code: 'DZ', name: 'Algérie', prefix: '+213', flag: 'dz'},
        {code: 'DE', name: 'Allemagne', prefix: '+49', flag: 'de'},
        {code: 'AO', name: 'Angola', prefix: '+244', flag: 'ao'},
        {code: 'SA', name: 'Arabie Saoudite', prefix: '+966', flag: 'sa'},
        {code: 'AU', name: 'Australie', prefix: '+61', flag: 'au'},
        {code: 'BE', name: 'Belgique', prefix: '+32', flag: 'be'},
        {code: 'BR', name: 'Brésil', prefix: '+55', flag: 'br'},
        ...
        {code: 'CN', name: 'Chine', prefix: '+86', flag: 'cn'},
        {code: 'CG', name: 'Congo', prefix: '+242', flag: 'cg'},
        {code: 'CI', name: 'Côte d\'Ivoire', prefix: '+225', flag: 'ci'},
        {code: 'ES', name: 'Espagne', prefix: '+34', flag: 'es'},
        {code: 'FR', name: 'France', prefix: '+33', flag: 'fr'},
        {code: 'GA', name: 'Gabon', prefix: '+241', flag: 'ga'},
        {code: 'GH', name: 'Ghana', prefix: '+233', flag: 'gh'},
        {code: 'GN', name: 'Guinée', prefix: '+224', flag: 'gn'},
        {code: 'IN', name: 'Inde', prefix: '+91', flag: 'in'},
        {code: 'IT', name: 'Italie', prefix: '+39', flag: 'it'},
        {code: 'JP', name: 'Japon', prefix: '+81', flag: 'jp'},
        {code: 'KE', name: 'Kenya', prefix: '+254', flag: 'ke'},
        {code: 'MG', name: 'Madagascar', prefix: '+261', flag: 'mg'},
        {code: 'ML', name: 'Mali', prefix: '+223', flag: 'ml'},
        {code: 'MA', name: 'Maroc', prefix: '+212', flag: 'ma'},
        {code: 'MX', name: 'Mexique', prefix: '+52', flag: 'mx'},
        {code: 'MZ', name: 'Mozambique', prefix: '+258', flag: 'mz'},
        {code: 'NE', name: 'Niger', prefix: '+227', flag: 'ne'},
        {code: 'NG', name: 'Nigeria', prefix: '+234', flag: 'ng'},
        {code: 'UG', name: 'Ouganda', prefix: '+256', flag: 'ug'},
        {code: 'NL', name: 'Pays-Bas', prefix: '+31', flag: 'nl'},
        {code: 'PT', name: 'Portugal', prefix: '+351', flag: 'pt'},
        {code: 'GB', name: 'Royaume-Uni', prefix: '+44', flag: 'gb'},
        {code: 'RU', name: 'Russie', prefix: '+7', flag: 'ru'},
        {code: 'RW', name: 'Rwanda', prefix: '+250', flag: 'rw'},
        {code: 'CD', name: 'République Démocratique du Congo', prefix: '+243', flag: 'cd'},
        {code: 'CH', name: 'Suisse', prefix: '+41', flag: 'ch'},
        {code: 'SN', name: 'Sénégal', prefix: '+221', flag: 'sn'},
        {code: 'TZ', name: 'Tanzanie', prefix: '+255', flag: 'tz'},
        {code: 'TG', name: 'Togo', prefix: '+228', flag: 'tg'},
        {code: 'TN', name: 'Tunisie', prefix: '+216', flag: 'tn'},
        {code: 'TR', name: 'Turquie', prefix: '+90', flag: 'tr'},
        {code: 'ZM', name: 'Zambie', prefix: '+260', flag: 'zm'},
        {code: 'ZW', name: 'Zimbabwe', prefix: '+263', flag: 'zw'},
        {code: 'EG', name: 'Égypte', prefix: '+20', flag: 'eg'},
        {code: 'AE', name: 'Émirats arabes unis', prefix: '+971', flag: 'ae'},
        {code: 'US', name: 'États-Unis', prefix: '+1', flag: 'us'},
        {code: 'ET', name: 'Éthiopie', prefix: '+251', flag: 'et'}
    ];
